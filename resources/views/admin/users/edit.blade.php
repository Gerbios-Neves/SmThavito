              ...
              <div class="card card-border-color card-border-color-primary">
                ...
                <div class="card-body">
                    <div class="form-group pt-2">
                      ...
                      <input class="form-control" value="{{$user->name}}" name='name' id="inputusuario" type="text" placeholder="Nome do Usuario">
                    </div>
                    <div class="form-group pt-2">
                      <label for="inputemail">Email</label>
                      <input class="form-control" value="{{$user->email}}" name="email" id="inputemail" type="email" placeholder="Email">
                    </div>
                    <div class="form-group pt-2">
                      <label for="password">Senha</label>
                      <input class="form-control" value="{{$user->password}}" name="password" id="password" type="password" placeholder="Senha">
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <div class="">
                        <select name="tipo_previlegio" class="form-control">
                          <option value="{{$user->tipo_previlegio}}" selected>{{$user->tipo_previlegio}}</option>
